...
def detect_pattern(sym, df):
    ...
    # ─────────────────────────────────────────────────────────
    # ENTRY ZONE: Price near EMA20 (pullback or fresh breakout)
    # ─────────────────────────────────────────────────────────
    dist_ema20_pct = (price - cur_ema20) / cur_ema20 * 100
    if dist_ema20_pct > CFG["pullback_upper_pct"]:   return None
    if dist_ema20_pct < -CFG["pullback_lower_pct"]:  return None
...
LIVE_COLS = [
    "Ticker","Price","Score",
    "EMA20","SMA50","SMA150",
    "Dist_EMA20_%","EMA20_Slope_%","EMA20_vs_SMA150_%",
...
_CW = {
    ...
    "Dist_EMA20_%":12,"EMA20_Slope_%":13,"EMA20_vs_SMA150_%":17,
    "Comp_Bars":10,"Best_Vol_x":11,"Surge_Date":12,"Surge_Bars_Ago":14,
    "MACD":9,"MACD_Hist":10,"RSI":6,"Cam_Near":9,
}
_CF = {
    "Price":"${:.2f}","Score":"{:.0f}",
    "EMA20":"${:.2f}","SMA50":"${:.2f}","SMA150":"${:.2f}",
    "Dist_EMA20_%":"{:+.2f}%","EMA20_Slope_%":"{:+.3f}%",
    "EMA20_vs_SMA150_%":"{:+.2f}%",
  ...
  <div style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:6px;
    ...
    EMA20_Slope > 0 = green line rising
        ...
        CLI_COLS = ["Ticker","Price","Score",
                    "Dist_EMA20_%","EMA20_Slope_%","Comp_Bars",
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  ENTRY:  Price within 3%–20% above EMA20 (green line)
          Best when: Dist_EMA20_% is closest to 0
          (price just touching or slightly above EMA20)

  💡 BEST SETUPS
  Comp_Bars > 15           long coil = more energy
  Dist_EMA20_% 0-5%       price right at EMA20 support
